    ...
    <div className="space-y-8 pb-24">
      ...
      <div className="space-y-1">
        ...
        <h1 className="text-4xl font-black text-white italic tracking-tighter">
          {totalNetBalance.toLocaleString("en-US", {
        ...
        <div className="flex items-center gap-2 mt-1">
          <span className="text-[10px] text-[#E2FF00] font-black uppercase tracking-widest italic">
            +{totalGrossProfit.toLocaleString()} TON Yield Harvested
          </span>
      ...
      {!wallet ? (
        <div className="bg-white/[0.02] border border-white/5 rounded-3xl p-8 flex flex-col items-center text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-[9px] text-white/30 uppercase tracking-[0.2em] font-bold max-w-[200px] mx-auto">
              Access your secure W5 Pamelo Account infrastructure
            </p>
          </div>
            ...
            <div className="flex items-start sm:items-center gap-5 flex-1">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <h3 className="text-base font-black text-white font-mono uppercase tracking-tighter italic leading-none">
                    EQ...3F8A
                  </h3>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  >
                    <span className="text-xl font-black text-[#E2FF00] italic uppercase tracking-tighter leading-none">
                      {formatCompactNumber(dailyLimit)}{" "}
                      <span className="text-[10px] opacity-40 not-italic ml-0.5 font-bold uppercase tracking-widest">
                        TON
                      </span>
                    </span>
            ...
            <div className="space-y-6 mb-10">
              <div className="space-y-3">
                ...
                <p className="text-[8px] text-white/20 font-bold uppercase tracking-widest px-1 leading-relaxed">
                  This limit is enforced at the W5 contract level. Any attempt
                  to move more than this amount within 24h will be automatically
                  rejected.
                </p>
              </div>
              ...
              <div className="p-4 bg-[#E2FF00]/5 border border-[#E2FF00]/10 rounded-2xl flex gap-3">
                ...
                <p className="text-[9px] text-[#E2FF00]/60 font-bold uppercase tracking-wider leading-relaxed">
                  Decreasing limits is instant. Increasing limits requires a
                  24-hour security delay on-chain.
                </p>
              </div>
            </div>
