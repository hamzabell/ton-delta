    ...
    <div className="min-h-screen bg-[#020617] text-white font-sans selection:bg-[#E2FF00]/20 overflow-x-hidden">
      ...
      <nav className="fixed top-0 z-50 w-full border-b border-white/5 bg-[#020617]/80 backdrop-blur-xl">
        <div className="flex items-center justify-between max-w-5xl mx-auto px-6 py-4">
          ...
          <Link
            href="/dashboard"
            className="bg-white/5 border border-white/10 px-5 py-2 rounded-full text-xs font-bold uppercase tracking-wider hover:bg-white/10 transition-all"
          >
            Launch App
          </Link>
        </div>
      ...
      <section className="pt-40 pb-20 px-6 text-center">
        ...
        <p className="max-w-md mx-auto text-sm md:text-base text-white/40 font-medium leading-relaxed mb-12 px-4 uppercase tracking-wider">
          ...
          yield. Non-custodial basis trading for the TON ecosystem.
        </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
            {[
              ...
              >
                ...
                <p className="text-[9px] font-bold text-white/20 uppercase tracking-[0.3em] mb-3">
                  {stat.label}
                </p>
                <p
                  className={`text-4xl lg:text-5xl font-black ${stat.color} tracking-tighter italic leading-none`}
                >
      ...
      <section className="py-32 px-6 border-t border-white/5 bg-white/[0.01]">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-[10px] font-bold text-[#E2FF00] uppercase tracking-[0.4em] mb-16 text-center">
            Protocol Workflow
          </h2>
          <div className="grid md:grid-cols-3 gap-16">
            {[
              ...
              <div key={i} className="space-y-4">
                <p className="text-3xl font-black italic text-white/10">
                  {item.step}
                </p>
      ...
      <footer className="py-12 border-t border-white/5 text-center px-6">
        <div className="flex items-center justify-center gap-2 mb-6">
          ...
          <span className="font-bold text-sm tracking-tight lowercase">
            pamelo.finance
          </span>
        </div>
        <p className="text-[10px] font-medium text-white/20 uppercase tracking-[0.3em]">
          © 2026 Institutional Grade Basis Yield
        </p>
      </footer>
    </div>
  );
