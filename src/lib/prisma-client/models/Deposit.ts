...
export type DepositWhereInput = {
  ...
  timestamp?: Prisma.DateTimeFilter<"Deposit"> | Date | string
...
export type DepositScalarWhereWithAggregatesInput = {
  ...
  timestamp?: Prisma.DateTimeWithAggregatesFilter<"Deposit"> | Date | string
}
...
export type DepositOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "amount" | "userId" | "timestamp", ExtArgs["result"]["deposit"]>
...
export interface DepositFieldRefs {
  ...
  readonly timestamp: Prisma.FieldRef<"Deposit", 'DateTime'>
}
